...
import { getallAuthors, getallCategories, getallTags } from "@/utils/doc-utils";
...
const Sidebar = ({ docs }) => {
  ...
  useEffect(() => {
    ...
    if (pathName.includes("/tags")) {
      ...
      matchedDocs = getallTags(docs, tag);
    } else if (pathName.includes("/authors")) {
      const author = pathName.split("/")[2];
      matchedDocs = getallAuthors(docs, author);
    } else if (pathName.includes("/categories")) {
      const category = pathName.split("/")[2];
      matchedDocs = getallCategories(docs, category);
    }
